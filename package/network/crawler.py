    ...
    while url_queue:
        ...
        try:
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                futures = [
                    executor.submit(download_file, file_url, os.path.basename(file_url))
...
def crawler():
    ...
    parser.add_argument("input_str", type=str, nargs="?", help="输入搜索查询或网址")
    parser.add_argument(
        "--type", type=str, default="image", choices=["image", "video"], help="文件类型"
    )
