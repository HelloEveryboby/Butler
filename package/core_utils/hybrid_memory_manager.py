...
class HybridMemoryManager:
    ...
    def __init__(self, memory_root: str = None):
        ...
        executable_path = os.path.join(project_root, "programs/hybrid_memory/memory_service")
    ...
    def search(self, query: str, max_results: int = 5) -> List[Dict[str, Any]]:
        ...
        try:
            result = self._client.call("search", {
    ...
    def get_file_content(self, relative_path: str, line_start: int = 1, num_lines: int = -1) -> str:
