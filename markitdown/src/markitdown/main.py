...
from .smarter import smart_up_markdown
...
if __name__ == "__main__":
    ...
    parser.add_argument("--smart", action="store_true", help="Use DeepSeek AI to improve the generated Markdown.")
    ...
    if not os.path.exists(args.file_path):
        ...
        if args.smart:
            print("Improving Markdown with DeepSeek AI... (this may take a moment)")
            markdown_content = smart_up_markdown(markdown_content)
