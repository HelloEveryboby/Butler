...
from core.butler_app import Butler
from utils.logger import LogManager
from utils.asset_loader import asset_loader
from utils.file_system.guard import FileSystemGuard
from utils.file_system.migration_engine import SmartMigrationEngine
from utils.device.hardware_manager import HardwareManager
from utils.core_utils.task_master.progress_tracker import ProgressTracker
import keyboard
from utils.event_bus import event_bus
from core.notifier_system import notifier
...
class ModernBridge:
    ...
    def handle_command(self, command):
        ...
        # 记录词频
        try:
            from core.memory.input_memory import input_memory
